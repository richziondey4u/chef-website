...
export default function Profile() {
  ...
  const handleBiometricSetup = async () => {
    try {
      ...
      toast(
        "Biometric setup requires a backend WebAuthn endpoint.\nAdd it when your backend is ready.",
        {
          icon: "🔐",
          duration: 5000,
        },
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-1">
              <div className="bg-white border border-gold/15 p-6 text-center">
                <div
                  className="w-24 h-24 rounded-full bg-gold flex items-center justify-center
                ...
                <div className="mt-3">
                  <span
                    className="text-xs px-3 py-1 bg-gold/10 text-gold border
            ...
            <div className="md:col-span-2">
              <div className="bg-white border border-gold/15 p-8">
                ...
                <div className="space-y-6">
                  <div>
                    <label
                      className="text-gold text-xs tracking-widest uppercase block mb-2"
                      style={{ fontSize: 9 }}
                    >
                      Full Name
                    </label>
                ...
                {bookings.map((booking) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        ...
                        <div className="flex items-center gap-3 mt-1 flex-wrap">
                          {booking.form_data?.date && (
                            <span
                              className="text-warm-gray font-body text-xs
                      ...
                      <span
                        className={`text-xs font-body px-3 py-1 rounded-sm
                capitalize shrink-0 ${
                  booking.status === "pending"
                    ...
                    {/* Key details from form */}
                    <div
                      className="grid grid-cols-2 gap-2 mt-4 pt-3
              border-t border-gold/10"
                    >
                      {booking.form_data?.venue && (
                        <div>
                          <div
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white border border-gold/15 p-8 md:col-span-2">
              ...
              <p className="text-warm-gray font-body text-sm leading-relaxed">
                ...
                to sign in again. All your data and order history is safely
                stored.
              </p>
            </div>
          </div>
