...
export default function AdminRoute({ children }) {
  ...
  // Profile loaded or timed out — check role
  if (!isAdmin) {
    return (
      <div className="min-h-screen bg-charcoal flex flex-col items-center
        justify-center gap-4 px-6 text-center">
        <div className="text-4xl">🚫</div>
        <h2 className="font-display text-3xl text-cream font-light">Access Denied</h2>
        <div className="w-14 h-px bg-gold" />
        <p className="text-warm-gray font-body text-sm max-w-sm">
